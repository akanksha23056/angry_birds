...
//    private Body selectedBody;
    ...
    public Level1GameScreen(Main game, String levelImagePath) {
        ...
        try {
            ...
            Gdx.app.error("Level1GameScreen", "Initialization error: " + e.getMessage(), e);
        }
    }
    ...
    public void show() {
        try {
            ...
            Gdx.app.error("Level1GameScreen", "Error in show(): " + e.getMessage(), e);
        }
    }
...
//            batch.end();
            ...
            Gdx.app.error("Level1GameScreen", "Error in drawPauseButton(): " + e.getMessage(), e);
        }
    }
    ...
    public void dispose() {
        try {
            ...
            Gdx.app.error("Level1GameScreen", "Error during dispose(): " + e.getMessage(), e);
        }
    }
