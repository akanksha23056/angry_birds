...
//    private Body selectedBody;
    ...
    public Level3GameScreen(Main game, String levelImagePath) {
        ...
        try {
            ...
            Gdx.app.error("Level3GameScreen", "Initialization error: " + e.getMessage(), e);
        }
    }
    ...
    public void show() {
        try {
            ...
            Gdx.app.error("Level3GameScreen", "Error in show(): " + e.getMessage(), e);
        }
    }
...
//            batch.end();
            ...
            Gdx.app.error("Level3GameScreen", "Error in drawPauseButton(): " + e.getMessage(), e);
        }
    }
    ...
    public void dispose() {
        try {
            ...
            Gdx.app.error("Level3GameScreen", "Error during dispose(): " + e.getMessage(), e);
        }
    }
